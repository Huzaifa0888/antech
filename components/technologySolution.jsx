      ...
      <section className="py-10 sm:py-16 lg:py-24 bg-blue-600 ">
        <div className="px-4 mx-auto max-w-[1150px] sm:px-6 lg:px-8 lg:pb-20">
          <div className=" mx-auto text-center">
            ...
            <h1 className="text-4xl font-bold text-center text-white   lg:text-[40px]">
              We Provide IT & Business Solutions
            </h1>
          </div>

          <div className="grid max-w-sm grid-cols-1 gap-6 mx-auto mt-8 lg:mt-16 lg:grid-cols-3 lg:max-w-full lg:gap-6">
            <div className="flex flex-col overflow-hidden bg-white shadow-md rounded-md">
              <div className="flex flex-col justify-center flex-1 px-6 py-8">
                ...
                <h1 className="text-3xl text-center font-extralight text-gray-600 sm:text-3xl pb-5 lg:text-[30px] ">
                  SEM Research
                </h1>
                <h1 className="text-2xl text-center font-extralight text-gray-400 sm:text-2xl pb-5 lg:text-[18px] ">
